...
static INT_PTR CALLBACK colorDialogDlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case rcHex:
            ...
            switch (LOWORD(wParam))
            {
            case rcH:       hChanged(c); break;
            case rcS:       sChanged(c); break;
            case rcV:       vChanged(c); break;
            case rcRDouble: rDoubleChanged(c); break;
            case rcGDouble: gDoubleChanged(c); break;
            case rcBDouble: bDoubleChanged(c); break;
            case rcADouble: aDoubleChanged(c); break;
            case rcRInt:    rIntChanged(c);    break;
            case rcGInt:    gIntChanged(c);    break;
            case rcBInt:    bIntChanged(c);    break;
            case rcAInt:    aIntChanged(c);    break;
            case rcHex:     hexChanged(c);     break;
            default: abort(); break;
            };
#else   
